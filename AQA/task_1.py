# Есть два словаря: рецепт пирога и запасы. Написать функцию, которая будет определять, сколько можно испечь пирогов из имеющихся запасов
...
#    количество пирогов=количество ингредиента в storageнеобходимое количество в recipe
#    количество пирогов=необходимое количество в recipeколичество ингредиента в storage​
